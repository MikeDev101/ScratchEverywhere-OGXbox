...
static bool loadSoundFromSB3(Sprite *sprite, const std::string &soundId, const bool &streamed = false);
/**
...
*/
static void startSoundLoaderThread(Sprite *sprite, const std::string &soundId, const bool &streamed = false, const bool &fromProject = true);
