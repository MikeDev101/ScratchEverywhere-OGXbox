...
class SoundPlayer {
  public:
    ...
    static bool loadSoundFromSB3(Sprite *sprite, void *zip, const std::string &soundId, const bool &streamed = false);    /**
     ...
     */
    static void startSoundLoaderThread(Sprite *sprite, void *zip, const std::string &soundId, const bool &streamed = false, const bool &fromProject = true);
